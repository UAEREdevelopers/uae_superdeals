...
use App\Mail\NewPackageInquiryReceived;
...
class SendPackageInterestInquiryReceivedEmails implements ShouldQueue
{
    ...
    public function handle()
    {
       $booking = $this->booking; 
        ...
        Mail::to($booking->email)->send(new NewPackageInquiryReceived($booking));
    }
}
