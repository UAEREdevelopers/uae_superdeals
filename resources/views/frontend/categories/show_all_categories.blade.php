...
@section('content')
	...
	<main>
		...
		<section class="hero_in hotels">
			<div class="wrapper">
				<div class="container">
					<h1 class="fadeInUp"><span></span>Categories</h1>
				</div>
			</div>
		</section>
		<!--/hero_in-->
			...
			<div class="row">
                ...
                @forelse ($categories as $category)
                    <div class="col-xl-4 col-lg-6 col-md-6 col-sm-6 mb-4">
                         <a href="{{ route('show_category', ['category' => $category->slug]) }}">
                                <div class="card">
                                    <img src="{{ $category->image }}" class="card-img-top"
                                        alt="{{ $category->name }}">
                                    <div class="card-body">
                                        <h5 class="card-title weekend-getaway-section-title text-center">{{ $category->name }}</h5>
                                      
                                        <div class="d-flex justify-content-center">
                                            
                                            <div>
                                                <a href="{{ route('show_category', ['category' => $category->slug]) }}"
                                                    class="btn">View Packages</a>
                                            </div>
                                        </div>
                                    </div>
                                </div>
