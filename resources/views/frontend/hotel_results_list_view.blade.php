						...
						<div class="row no-gutters">
							<div class="col-lg-5">
								<figure>
									...
									<a href="{{route('hotel_detail_view', ['id' => $hotel['HCode']])}}"><img src="{{$hotel['Image']}}" class="img-fluid" alt="" width="200px" height="auto"><div class="read_more"><span>Read more</span></div></a>
								</figure>
							</div>
							<div class="col-lg-7">
								<div class="wrapper">
									<a href="{{route('hotel_detail_view', ['id' => $hotel['HCode']])}}" class="wish_bt"></a>
									{{-- <div class="cat_star">
                                     @for($i = 0; $i< $hotel->StarRating; $i++)   
                                    <i class="icon_star">
                                    @endfor
                                    </div> --}}
									<h3><a href="{{route('hotel_detail_view', ['id' => $hotel['HCode']])}}">{{$hotel['HName']}}</a></h3>
									<p>{{$hotel['Address']}}, {{$hotel['city']}}  </p>
									<span class="price">From <strong>{{$currency}} {{$hotel['price']}}</strong></span>
								</div>
								<ul>
